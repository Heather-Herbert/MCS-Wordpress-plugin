        ...
        if (strlen($accessKey) > 0) {
            if ( ! wp_is_post_revision( $post_id ) ){
                ...
                if ($this->mcs_settings_options['entities_2']) {
                    if (strpos($post->post_content, "<div id='MCS-keyPhrases'></div>") !== true) {

                        $post->post_content = $post->post_content . "<div id='MCS-keyPhrases'></div>";
                ...
                if ($this->mcs_settings_options['keyphrases_3']) {
                    if (strpos($post->post_content, "<div id='MCS-entities'></div>") !== true) {

                        $post->post_content = $post->post_content . "<div id='MCS-entities'></div>";
